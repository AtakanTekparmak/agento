...
if not (os.getenv("DEFAULT_MODEL") and os.getenv("BASE_URL") and os.getenv("OPENAI_API_KEY")):
    ...
    print("DEFAULT_MODEL:", "qwen2.5-coder:7b-instruct-q8_0")
    print("BASE_URL:", "http://localhost:11434/v1")
    print("OPENAI_API_KEY:", "ollama")

# Define the settings
SYSTEM_PROMPT_PATH = "agento/system_prompt.txt"
DEFAULT_MODEL = os.getenv("DEFAULT_MODEL") if os.getenv("DEFAULT_MODEL") else "qwen2.5-coder:7b-instruct-q8_0" # Default model for the agent
